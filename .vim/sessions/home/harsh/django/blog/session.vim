...
set shortmess=aoO
badd +42 blog/settings.py
badd +14 blog/urls.py
badd +1 manage.py
badd +31 links/models.py
badd +2 links/admin.py
badd +8 links/views.py
badd +13 blog/templates/links/link_list.html
badd +7 blog/templates/base.html
silent! argdel *
edit links/models.py
