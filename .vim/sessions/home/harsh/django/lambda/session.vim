...
set shortmess=aoO
badd +87 lambda/settings.py
badd +15 lambda/urls.py
badd +3 links/models.py
badd +11 links/admin.py
badd +3 links/views.py
badd +3 lambda/templates/links/link_list.html
badd +19 lambda/templates/base.html
badd +1 links/forms.py
badd +8 lambda/templates/register.html
silent! argdel *
edit lambda/urls.py
