...
set shortmess=aoO
badd +0 .vim/bundle/vim-colorschemes/colors/molokai-dark.vim
args .vim/bundle/vim-colorschemes/colors/molokai-dark.vim
edit .vim/bundle/vim-colorschemes/colors/molokai-dark.vim
...
silent! normal! zE
let s:l = 506 - ((17 * winheight(0) + 18) / 37)
