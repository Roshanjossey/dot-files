...
badd +92 category_group_id/category_group_id/spiders/memory_card.py
badd +1 spec_id/spec_id/pipelines.py
badd +62 category_group_id/category_group_id/spiders/battery.py
silent! argdel *
edit category_group_id/category_group_id/spiders/memory_card.py
...
silent! normal! zE
let s:l = 85 - ((31 * winheight(0) + 19) / 39)
