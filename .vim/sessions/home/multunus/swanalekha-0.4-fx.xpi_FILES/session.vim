...
silent only
cd ~/swanalekha-0.4-fx.xpi_FILES
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +7 content/swanalekha.js
badd +1 content/prefman.js
badd +245 content/script-compiler.js
badd +89 content/xmlhttprequester.js
argglobal
silent! argdel *
edit content/prefman.js
...
let s:l = 71 - ((21 * winheight(0) + 21) / 43)
