...
xnoremap ,rem :RExtractMethod
xnoremap ,rriv :RRenameInstanceVariable
xnoremap ,rrlv :RRenameLocalVariable
xnoremap ,relv :RExtractLocalVariable
xnoremap ,rec :RExtractConstant
...
nnoremap ; :
xnoremap ; :
nnoremap RS :call OpenRspecDoc(expand('<cword>'))
xnoremap RS :call OpenRspecDoc(expand('<cword>'))
onoremap RS :call OpenRspecDoc(expand('<cword>'))
nnoremap RR :call OpenRailsDoc(expand('<cword>'))
xnoremap RR :call OpenRailsDoc(expand('<cword>'))
onoremap RR :call OpenRailsDoc(expand('<cword>'))
nnoremap RB :call OpenRubyDoc(expand('<cword>'))
xnoremap RB :call OpenRubyDoc(expand('<cword>'))
onoremap RB :call OpenRubyDoc(expand('<cword>'))
...
silent only
cd ~/training/ruby/resume
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +18 spec/export_spec.rb
badd +10 user.rb
badd +1 spec/user_spec.rb
badd +3 plugins/pdf.rb
badd +11 export.rb
badd +29 driver.rb
argglobal
silent! argdel *
edit spec/user_spec.rb
...
exe 'vert 1resize ' . ((&columns * 47 + 47) / 95)
exe '2resize ' . ((&lines * 21 + 23) / 46)
exe 'vert 2resize ' . ((&columns * 47 + 47) / 95)
exe '3resize ' . ((&lines * 21 + 23) / 46)
exe 'vert 3resize ' . ((&columns * 63 + 47) / 95)
exe '4resize ' . ((&lines * 21 + 23) / 46)
exe 'vert 4resize ' . ((&columns * 31 + 47) / 95)
argglobal
snoremap <buffer> <silent>  :call UltiSnips#JumpForwards()
snoremap <buffer> <silent>  :call UltiSnips#JumpBackwards()
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> ,b <Plug>BlockToggle
xmap <buffer> ,b <Plug>BlockToggle
omap <buffer> ,b <Plug>BlockToggle
